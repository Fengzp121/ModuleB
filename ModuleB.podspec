Pod::Spec.new do |spec|
  ...
  spec.homepage     = 'https://github.com/Fengzp121/ModuleB'
  ...
  spec.source       = { :git => 'https://github.com/Fengzp121/ModuleB.git', :tag => spec.version.to_s }

  spec.requires_arc = true
  
  spec.subspec 'Client' do |client|
       client.source_files = "ModuleB/Client/**/*.{h,m}"
